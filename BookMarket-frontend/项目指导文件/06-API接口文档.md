...
| sellerIsVerified | Boolean | 是否认证卖家 |
| sellerDescription | String | 卖家描述 |
| sellerPositiveRate | Number | 卖家好评率 |
| sellerRating | Number | 卖家评分 |
| sellerSalesCount | Number | 销售数量 |
...
| level | String | 否 | 会员等级 |
| isSeller | Boolean | 否 | 是否卖家 |
| sellerLevel | String | 否 | 卖家等级 |
| sellerIsVerified | Boolean | 否 | 是否认证卖家 |
| sellerDescription | String | 否 | 卖家描述 |
| sellerPositiveRate | Number | 否 | 卖家好评率 |
| sellerRating | Number | 否 | 卖家评分 |
| sellerSalesCount | Number | 否 | 销售数量 |
...
| condition | String | 否 | 新旧程度（全新/九成新/八成新/七成新/六成新及以下） |
...
```json
{
  ...
  "data": {
    ...
    "description": "本书为九成新，封面有轻微使用痕迹，内页整洁无笔记无划痕...",
    "sellerId": 1,
    "status": 1,
    "createdAt": "2024-01-15T10:00:00Z",
    "updatedAt": "2024-01-15T10:00:00Z"
...
**URL路径**：`/books/:id/reviews/statistics`
...
**URL路径**：`/books/:id/related`

**请求参数**：

| 参数名 | 类型 | 必填 | 说明 |
|-------|------|------|------|
| limit | Number | 否 | 限制数量，默认4 |
...
| 字段名 | 类型 | 说明 |
|-------|------|------|
| id | Number | 用户ID（同时也是卖家ID） |
| username | String | 用户名（店铺名称） |
| avatar | String | 头像URL |
| sellerLevel | String | 卖家等级 |
| sellerIsVerified | Boolean | 是否认证卖家 |
| sellerRating | Number | 卖家评分 |
...
```json
{
  ...
  "data": {
    ...
    "sellerDescription": "专注计算机技术类书籍，保证正版，发货迅速，欢迎选购！",
